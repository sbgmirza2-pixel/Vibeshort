...
// Configure common public DNS servers (Google & Cloudflare) to fix MongoDB Atlas SRV query resolution issues in local dev
try {
  ...
  // DNS configuration fallback if restricted in specific environments
}
